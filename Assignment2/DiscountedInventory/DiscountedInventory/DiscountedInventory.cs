...
namespace DiscountedInventory
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            if (userName == "Swornashabi")
            {
                string response;
                response = choice switch
                {
                    1 => "Ropes cost " + 0.5 * 10 + " gold.",
                    2 => "Torches cost " + 0.5 * 15 + " gold.",
                    3 => "Climbing equipments cost " + 0.5 * 25 + " gold.",
                    4 => "Clean Water cost " + 0.5 * 1 + " gold.",
                    5 => "Machete cost " + 0.5 * 20 + " gold.",
                    6 => "Canoe cost " + 0.5 * 200 + " gold.",
                    7 => "Food Supplies cost " + 0.5 * 1 + " gold.",
